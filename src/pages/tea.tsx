    ...
    <Stack justify="center" align="center" gap={150}>
      ...
      <Stack justify="center" align="center" gap={100}>
        ...
        <Group justify="space-evenly" align="center" gap={30} w="80vw">
          <TeaInfo
            icon="/icons/caffeineIcon.svg"
            title="Caffeine Level"
            text={caffeineLevel?.toString()}
          />
          <TeaInfo
            icon="/icons/typeOfTeaIcon.svg"
            title="Type of Tea"
            text={type?.toString()}
          />
          <TeaInfo
            icon="/icons/flavorIcon.svg"
            title="Flavor"
            text={flavor?.toString()}
          />
          <TeaInfo
            icon="/icons/benefitIcon.svg"
            title="Benefit"
